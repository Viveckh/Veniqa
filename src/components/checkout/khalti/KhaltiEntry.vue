...
export default {
  ...
  methods:{
    ...
    let khaltiConfig = {
      ...
      "productIdentity": this.config.productIdentity ? this.config.productIdentity : "1234567890",
      "productName": this.config.productName ? this.config.productName : "Drogon",
      "productUrl": this.config.productUrl ? this.config.productUrl : 'https://www.veniqa.com',
      "eventHandler": {
            onSuccess (payload) {
