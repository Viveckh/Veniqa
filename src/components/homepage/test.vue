<template>
  <div class="jumbotron d-flex align-items-center">
    <div class="container">
      <b-container class="featuredCat">
        <b-row align-v="start" class="main">
          <b-col sm="3">
            <b-row
              align-v="start"
              class="section section1 justify-content-center align-items-center"
            >
          ...
          <b-col sm="3">
            <b-row
              align-v="start"
              class="section section2 justify-content-center align-items-center"
            >
              <b-col sm="12">
            ...
            <b-row
              align-v="start"
              class="section section3 justify-content-center align-items-center"
            >
              <b-col sm="12">
          ...
          <b-col sm="3">
            <b-row
              align-v="start"
              class="section section4 justify-content-center align-items-center"
            >
              <b-col sm="12">
            ...
            <b-row
              align-v="start"
              class="section section5 justify-content-center align-items-center"
            >
              <b-col sm="12">
          ...
          <b-col sm="3">
            <b-row
              align-v="start"
              class="section section6 justify-content-center align-items-center"
            >
              <b-col sm="12">
            ...
            <b-row
              align-v="start"
              class="section section7 justify-content-center align-items-center"
            >
              <b-col sm="12">
