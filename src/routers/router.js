...
router.beforeEach((to, from, next) => {
  // For each route, check if the route needs auth. If yes and local Storage doesn't have anything stored, then, reroute to login page.
  // Currently when the user is logged in, the user's email is stored in local storage.
